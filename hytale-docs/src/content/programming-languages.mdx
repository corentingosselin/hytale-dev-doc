...
## Modding Languages & Scope (FAQ)

**Q: What language should I use for server mods/plugins?**  
A: Java is the only language consistently referenced for server-side plugins. Other JVM languages (Kotlin/Scala) are likely to work but are community-supported.

**Q: Is client-side scripting confirmed?**  
A: Not officially. JavaScript/TypeScript scripting was shown in the 2018 trailer, but current support details and scope are unconfirmed.

**Q: Can I write client mods in C#?**  
A: No official client modding API for C# has been announced. Treat any client-side language assumptions as speculative until official docs confirm them.

**Q: Is this information official?**  
A: Some of it is community-sourced and based on past trailers or Discord discussion. Treat uncertain points as provisional until official documentation is published.
...
public class MyPlugin extends JavaPlugin {
    ...
    protected void setup() {
        getLogger().atInfo().log("Setting up plugin...");
    }
...
class MyPlugin : JavaPlugin() {
    override fun setup() {
        logger.atInfo().log("Setting up plugin...")
    }

...
> "It is our own. Custom for Hytale but meant to be less complex than other highly optimized ECS solutions." - Slikey (Tech Director)
...
**Custom Components:**
> "You can register a new component on those container entities" - Slikey
...
The Store holds all components for all entities:
...
**Threading Note:**
> "When a chunk is being ticked, all other chunks within a certain radius are locked" - ShreddedPaper-style approach
...
## ECS vs Traditional Minecraft

### Bukkit/Spigot (Traditional)

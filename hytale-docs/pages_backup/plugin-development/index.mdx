...
Hytale plugins are written in Java and run on the server. The plugin system is similar to Minecraft's Spigot/Paper but with modern architecture including ECS (Entity Component System) patterns.
...
2. Practice with Minecraft Spigot/Paper plugins
...
> "Spigot/Paper plugin development is great practice for Hytale." - Learning recommendation

> "The event system is similar to Spigot but with ECS patterns." - Architecture discussion
